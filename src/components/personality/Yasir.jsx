...
function Yasir() {
  return (
    <div className="relative w-screen 2xl:h-[40%] lg:h-[40%] md:h-{30%} pb-5 bg-[url('https://i.pinimg.com/originals/a5/de/39/a5de392b257f6c85f23c0a7cc91feb95.gif')] bg-no-repeat bg-cover">
      <RocketCards />
      <div className="pt-20">
        <img
